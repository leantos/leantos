...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Stack-MERN%20%26%20Infra-blueviolet?style=flat-square" alt="Stack Badge"/>
  <img src="https://img.shields.io/badge/Focus-DBRE%2FSRE-success?style=flat-square" alt="DBRE/SRE Badge"/>
  <img src="https://img.shields.io/badge/Aspiring-SDE1%2FDBRE-blue?style=flat-square" alt="Aspiring Badge"/>
</p>

<h1 align="center">Hi, I'm Emmanuel Tom Jose 👋</h1>

<p align="center">
  <b>Full Stack Developer & Infrastructure Reliability Engineer | Bangalore, India</b>
</p>
...
- 📊 Learning Systems Design & SRE fundamentals
...
- **🚀 Expanding focus: Infrastructure Reliability Engineering (DBRE/SRE) — building production-grade systems with Postgres, Kubernetes, high-availability patterns, and compliance automation**
...
#### Infrastructure & Reliability (New Focus)
![Kubernetes](https://img.shields.io/badge/-Kubernetes-black?style=flat-square&logo=kubernetes)
![Postgres HA](https://img.shields.io/badge/-Postgres%20HA%20(Patroni)-black?style=flat-square&logo=postgresql)
![pgBackRest](https://img.shields.io/badge/-pgBackRest-black?style=flat-square&logo=postgresql)
...
<p>
  ...
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/kubernetes/kubernetes-plain.svg" alt="Kubernetes" width="32" title="Kubernetes"/>
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/terraform/terraform-original.svg" alt="Terraform" width="32" title="Infrastructure as Code"/>
</p>
...
![High-Availability Patterns](https://img.shields.io/badge/-High--Availability%20Patterns-black?style=flat-square)
![SLO/SLI Observability](https://img.shields.io/badge/-SLO%2FSLI%20Observability-black?style=flat-square)
![Backup & Disaster Recovery](https://img.shields.io/badge/-Backup%20&%20Disaster%20Recovery-black?style=flat-square)
![Compliance & Audit](https://img.shields.io/badge/-Compliance%20&%20Audit-black?style=flat-square)
...
### 🔧 OSS Contributions & Case Studies

- **[Continue.dev Issue #6191](https://github.com/continuedev/continue/issues/6191):** Debugged HTTP 401 authentication regression in OpenRouter/Groq provider handling (v1.0.13). Provided comprehensive root-cause analysis, working configuration guide, and setup documentation. Endorsed by core maintainer [@Patrick-Erichsen](https://github.com/Patrick-Erichsen). **Became reference solution for community.** *(Resolved Aug 2025)*
...
- **Certified Kubernetes Administrator (CKA) - currently working through**
- **SRE Handbook - currently reading**
- **Systems Design & Reliability Patterns - in progress**
...
- **Infrastructure & Reliability:** Building production-grade systems with PostgreSQL (Patroni, pgBackRest), Kubernetes controllers (Go), SLOs/SLI observability (Prometheus, Grafana)
- **SRE Practices:** Incident response, blameless postmortems, error budgets, on-call readiness, runbook automation
- **Kubernetes Mastery:** CKA preparation, advanced workload management, networking, security policies, resource optimization
- **Banking-grade systems:** Idempotency patterns, audit trails, serializable transactions, compliance automation (ISO 9001, SOC 2, GDPR)
- **Cloud & IaC:** AWS (EKS), Terraform, Helm, backup/restore drills, cloud-native patterns
- **Open-source contributions:** Patroni, Kubernetes ecosystem, production incident case studies
- **EU career path:** Targeting mid-senior DBRE/SRE roles with focus on reliability, observability, and operational excellence
...
- Contribute to open-source & real-world problem solving (especially in Postgres HA, Kubernetes controllers, and SRE tooling)
- Land a role as **DBRE / SRE** or **SDE 1** in infrastructure/reliability (with EU sponsorship opportunities)
- Master system design, scalable backend patterns, HA architectures, and compliance automation
- Achieve **CKA certification** and deepen SRE practices across incident response, observability, and reliability engineering
- Build verifiable portfolio artifacts: public GitHub repos, production incidents case studies, compliance documentation
